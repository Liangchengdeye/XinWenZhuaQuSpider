# -*- coding: utf-8 -*-
# en_people.Science网爬取内容
# create 2017/9/18 W_H_J

import scrapy
from News.items import en_people_science
from News.dbhelper import DBHelper
class en_people_Society(scrapy.Spider):
        name = "en_people_Science"
        # 爬虫爬取的数据范围
